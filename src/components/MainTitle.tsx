...
const MainTitle = () => {
    return (
        <Grid container width={'100%'} flexDirection={'column'} justifyContent={'space-around'} gap={'4px'}>
            ...
            <Typography alignSelf={'flex-start'} fontFamily={'Source Sans Pro'} fontWeight={'400'} variant={'h5'} fontSize={'14px'}>Easy &#183; {exercises.getMaxWorkoutTime()} &#183; no equipment</Typography>
        </Grid>
    );
};
